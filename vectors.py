...
# relpoint = [0,0,0]
# coords = [[-.5,-.5,0], [.5,-.5,0], [0,1,0]]
# newcoords = rotate(coords, theta=(0), relative_point=relpoint, axis=0, unit='degrees', toarray=True)


# x,y,z = zip(*newcoords)
# #trick to close loop by adding initial point to the end
# x = x+(x[0],)
# y = y+(y[0],)

# plt.plot(x, y)
# plt.scatter(relpoint[0], relpoint[1])
